                ...
                <form class="form" role="form" @submit.prevent="$emit('passdata', info)">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="domanda1" class="col-form-label"><!--{{ lang.name }}:--><b>Frase/Domanda(sotto la foto)</b></label>
                            <textarea class="form-control" id="sent1" name="sent1" v-model="info.info.sent1" required="required"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="domanda2" class="col-form-label"><!--{{ lang.name }}:--><b>Frase/Domanda(Motivo Risposta)</b></label>
                            <textarea class="form-control" id="sent2" name="sent2" v-model="info.info.sent2" required="required"></textarea>
                        </div>
                        <div class="form-group">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="use_yes" required="required" v-model="info.info.use_yes" />
                        ...
                        <div class="form-group">
                            <div class="form-check mt-4">
                                <input class="form-check-input " type="checkbox" id="other" v-model="info.info.other"  checked/>
                                <label class="form-check-label" for="checkAltro">
                                    <b>Permetti all'utente di scrivere una risposta</b>
                                </label>
                            </div>
                        </div>
                        <hr/>
                      ...
                      <div class="input wrapper flex items-center" 
                                v-for="(input, index) in opzioni"
                                :key="`opzioneInput-${index}`">
                             <div class="row mt-2">
                                 <div class="col-md-6">
                            <input
                                type="text"
